  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-input bg-background hover:bg-accent hover:text-accent-foreground hover:-translate-y-[1px] hover:shadow-soft',
        secondary:
          'bg-secondary text-secondary-foreground hover:bg-secondary/80 hover:-translate-y-[1px]',
        ghost: 'hover:bg-accent hover:text-accent-foreground',
        link: 'text-primary underline-offset-4 hover:underline',
        // Brand variants for primary CTAs
        brand: 'bg-brand-500 text-white hover:bg-brand-600 hover:-translate-y-[1px] hover:shadow-medium shadow-soft',
        'brand-outline': 'border-2 border-brand-500 text-brand-600 hover:bg-brand-50 hover:-translate-y-[1px] hover:shadow-soft',
