            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-4 text-sm text-muted-foreground">
                ...
                {currentWorkspaceName && (
                  <>
                    <span className="text-border">·</span>
                    <span className="text-muted-foreground/70">{currentWorkspaceName}</span>
                  </>
                )}
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto w-full flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex-1 flex overflow-hidden">
            {isInitialLoading ? (
              /* Loading Skeleton */
              <>
                <div className="w-[30%] border-r border-border bg-card p-4">
                  <div className="space-y-4 animate-pulse">
                    ...
                    <div className="h-24 bg-muted/60 rounded-lg mt-auto" />
                  </div>
                </div>
                <div className="w-[45%] border-r border-border bg-muted/20 p-4">
                ...
                <div className="w-[25%] bg-card p-4">
                  <div className="space-y-4 animate-pulse">
